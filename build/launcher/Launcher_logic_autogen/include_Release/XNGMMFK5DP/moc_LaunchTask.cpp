...
#include "../../../../../Codigo fuente/PrismLauncher-develop/launcher/launch/LaunchTask.h"
...
constexpr auto qt_meta_stringdata_CLASSLaunchTaskENDCLASS = QtMocHelpers::stringData(
    "LaunchTask",
    "readyForLaunch",
    "",
    "requestProgress",
...
void LaunchTask::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->onLogLines((*reinterpret_cast< std::add_pointer_t<QStringList>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<MessageLevel>>(_a[2]))); break;
        case 4: _t->onLogLines((*reinterpret_cast< std::add_pointer_t<QStringList>>(_a[1]))); break;
        case 5: _t->onLogLine((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<MessageLevel>>(_a[2]))); break;
