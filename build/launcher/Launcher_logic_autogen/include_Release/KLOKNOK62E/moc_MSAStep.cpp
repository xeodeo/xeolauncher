...
#include "../../../../../Codigo fuente/PrismLauncher-develop/launcher/minecraft/auth/steps/MSAStep.h"
...
constexpr auto qt_meta_stringdata_CLASSMSAStepENDCLASS = QtMocHelpers::stringData(
    "MSAStep",
...
void MSAStep::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (MSAStep::*)(const QUrl & );
            if (_t _q_method = &MSAStep::authorizeWithBrowser; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MSAStep::authorizeWithBrowser(const QUrl & _t1)
{
