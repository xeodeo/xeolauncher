...
#include "../../../../../Codigo fuente/PrismLauncher-develop/launcher/ui/pages/modplatform/CustomPage.h"
...
struct qt_meta_stringdata_CLASSCustomPageENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSCustomPageENDCLASS = QtMocHelpers::stringData(
    "CustomPage",
    "setSelectedVersion",
    "",
    "BaseVersion::Ptr",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSCustomPageENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject CustomPage::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSCustomPageENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSCustomPageENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSCustomPageENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<CustomPage, std::true_type>,
...
void *CustomPage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSCustomPageENDCLASS.stringdata0))
