...
#include "../../../../../Codigo fuente/PrismLauncher-develop/launcher/ui/pages/modplatform/flame/FlamePage.h"
...
constexpr auto qt_meta_stringdata_CLASSFlamePageENDCLASS = QtMocHelpers::stringData(
    "FlamePage",
    "triggerSearch",
    "",
    "onSelectionChanged",
...
void FlamePage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->onVersionSelectionChanged((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
