...
#include "../../../../../Codigo fuente/PrismLauncher-develop/launcher/modplatform/legacy_ftb/PackFetchTask.h"
...
constexpr auto qt_meta_stringdata_CLASSLegacyFTBSCOPEPackFetchTaskENDCLASS = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_CLASSLegacyFTBSCOPEPackFetchTaskENDCLASS[] = {
 ...
 // slots: name, argc, parameters, tag, flags, initial metatype offsets
      14,    2,   79,    2, 0x09,   12 /* Protected */,
      18,    1,   84,    2, 0x09,   15 /* Protected */,
      19,    0,   87,    2, 0x09,   17 /* Protected */,
...
void LegacyFTB::PackFetchTask::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 5: _t->fileDownloadFinished((*reinterpret_cast< std::add_pointer_t<QByteArray*>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QByteArray*>>(_a[2]))); break;
        ...
        {
            using _t = void (PackFetchTask::*)(const Modpack & );
...
// SIGNAL 3
void LegacyFTB::PackFetchTask::privateFileDownloadFinished(const Modpack & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
