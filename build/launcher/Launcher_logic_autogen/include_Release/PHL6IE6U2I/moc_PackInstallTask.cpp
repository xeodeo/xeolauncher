...
#include "../../../../../Codigo fuente/PrismLauncher-develop/launcher/modplatform/legacy_ftb/PackInstallTask.h"
...
constexpr auto qt_meta_stringdata_CLASSLegacyFTBSCOPEPackInstallTaskENDCLASS = QtMocHelpers::stringData(
...
void LegacyFTB::PackInstallTask::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->onUnzipFinished(); break;
        case 1: _t->onUnzipCanceled(); break;
        default: ;
        }
    }
    (void)_a;
