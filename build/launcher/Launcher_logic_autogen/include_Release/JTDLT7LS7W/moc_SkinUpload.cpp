...
#include "../../../../../Codigo fuente/PrismLauncher-develop/launcher/minecraft/skins/SkinUpload.h"
...
constexpr auto qt_meta_stringdata_CLASSSkinUploadENDCLASS = QtMocHelpers::stringData(
    "SkinUpload"
);
...
Q_CONSTINIT const QMetaObject SkinUpload::staticMetaObject = { {
    QMetaObject::SuperData::link<Net::NetRequest::staticMetaObject>(),
...
void *SkinUpload::qt_metacast(const char *_clname)
{
    ...
    return Net::NetRequest::qt_metacast(_clname);
}

int SkinUpload::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = Net::NetRequest::qt_metacall(_c, _id, _a);
    return _id;
}
QT_WARNING_POP
