...
public:
    ...
    void setupUi(QDialog *ReviewMessageBox)
    {
        ...
        toggleDepsButton = new QPushButton(ReviewMessageBox);
        toggleDepsButton->setObjectName("toggleDepsButton");

        horizontalLayout->addWidget(toggleDepsButton);
    ...
    {
        toggleDepsButton->setText(QCoreApplication::translate("ReviewMessageBox", "Toggle Dependencies", nullptr));
