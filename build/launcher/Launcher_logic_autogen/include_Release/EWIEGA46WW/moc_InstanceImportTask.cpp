...
#include "../../../../../Codigo fuente/PrismLauncher-develop/launcher/InstanceImportTask.h"
...
constexpr auto qt_meta_stringdata_CLASSInstanceImportTaskENDCLASS = QtMocHelpers::stringData(
    "InstanceImportTask",
    "processZipPack",
    "",
    "extractFinished"
...
void InstanceImportTask::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->processZipPack(); break;
        case 1: _t->extractFinished(); break;
        default: ;
        }
    }
    (void)_a;
