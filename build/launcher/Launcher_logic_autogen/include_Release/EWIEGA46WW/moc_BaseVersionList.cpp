...
#include "../../../../../Codigo fuente/PrismLauncher-develop/launcher/BaseVersionList.h"
...
constexpr auto qt_meta_stringdata_CLASSBaseVersionListENDCLASS = QtMocHelpers::stringData(
    "BaseVersionList",
    "updateListData",
    "",
