...
#include "../../../../../Codigo fuente/PrismLauncher-develop/launcher/JavaCommon.h"
...
constexpr auto qt_meta_stringdata_CLASSJavaCommonSCOPETestCheckENDCLASS = QtMocHelpers::stringData(
...
void JavaCommon::TestCheck::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->checkFinished((*reinterpret_cast< std::add_pointer_t<JavaChecker::Result>>(_a[1]))); break;
        case 2: _t->checkFinishedWithArgs((*reinterpret_cast< std::add_pointer_t<JavaChecker::Result>>(_a[1]))); break;
        default: ;
        }
