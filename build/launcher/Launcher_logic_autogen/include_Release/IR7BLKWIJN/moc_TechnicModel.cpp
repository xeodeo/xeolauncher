...
#include "../../../../../Codigo fuente/PrismLauncher-develop/launcher/ui/pages/modplatform/technic/TechnicModel.h"
...
constexpr auto qt_meta_stringdata_CLASSTechnicSCOPEListModelENDCLASS = QtMocHelpers::stringData(
    "Technic::ListModel",
...
void Technic::ListModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->searchRequestFinished((*reinterpret_cast< std::add_pointer_t<QByteArray*>>(_a[1]))); break;
