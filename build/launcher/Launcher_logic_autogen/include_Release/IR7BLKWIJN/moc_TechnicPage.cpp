...
#include "../../../../../Codigo fuente/PrismLauncher-develop/launcher/ui/pages/modplatform/technic/TechnicPage.h"
...
constexpr auto qt_meta_stringdata_CLASSTechnicPageENDCLASS = QtMocHelpers::stringData(
    "TechnicPage",
    "triggerSearch",
    "",
    "onSelectionChanged",
...
void TechnicPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->onSolderLoaded((*reinterpret_cast< std::add_pointer_t<QByteArray*>>(_a[1]))); break;
