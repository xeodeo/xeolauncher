...
#include "../../../../../Codigo fuente/PrismLauncher-develop/launcher/minecraft/auth/AuthStep.h"
...
constexpr auto qt_meta_stringdata_CLASSAuthStepENDCLASS = QtMocHelpers::stringData(
    "AuthStep",
    "finished",
    "",
    "AccountTaskState",
