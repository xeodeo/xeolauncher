...
#include "../../../../../Codigo fuente/PrismLauncher-develop/launcher/ui/pages/instance/ShaderPackPage.h"
...
constexpr auto qt_meta_stringdata_CLASSShaderPackPageENDCLASS = QtMocHelpers::stringData(
    "ShaderPackPage",
    "downloadShaderPack",
    "",
...
Q_CONSTINIT const QMetaObject ShaderPackPage::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSShaderPackPageENDCLASS_t,
        ...
        // method 'downloadShaderPack'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'downloadDialogFinished'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<int, std::false_type>,
        // method 'updateShaderPacks'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'deleteShaderPackMetadata'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'changeShaderPackVersion'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
    nullptr
} };
...
void ShaderPackPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->downloadShaderPack(); break;
        case 1: _t->downloadDialogFinished((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 2: _t->updateShaderPacks(); break;
        case 3: _t->deleteShaderPackMetadata(); break;
        case 4: _t->changeShaderPackVersion(); break;
        default: ;
        }
    }
}
