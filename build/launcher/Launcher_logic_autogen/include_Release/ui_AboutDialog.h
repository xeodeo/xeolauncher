...
public:
    ...
    void setupUi(QDialog *AboutDialog)
    {
        ...
        platformLabel->setCursor(QCursor(Qt::CursorShape::IBeamCursor));
        ...
        buildDateLabel->setCursor(QCursor(Qt::CursorShape::IBeamCursor));
        ...
        commitLabel->setCursor(QCursor(Qt::CursorShape::IBeamCursor));
        ...
        channelLabel->setCursor(QCursor(Qt::CursorShape::IBeamCursor));
        ...
        verticalSpacer = new QSpacerItem(20, 212, QSizePolicy::Policy::Minimum, QSizePolicy::Policy::Expanding);
