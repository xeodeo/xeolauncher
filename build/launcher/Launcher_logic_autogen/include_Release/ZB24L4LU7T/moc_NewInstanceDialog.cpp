...
#include "../../../../../Codigo fuente/PrismLauncher-develop/launcher/ui/dialogs/NewInstanceDialog.h"
...
constexpr auto qt_meta_stringdata_CLASSNewInstanceDialogENDCLASS = QtMocHelpers::stringData(
    "NewInstanceDialog",
    "accept",
    "",
    "reject",
...
void NewInstanceDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->selectedPageChanged((*reinterpret_cast< std::add_pointer_t<BasePage*>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<BasePage*>>(_a[2]))); break;
        default: ;
        }
    }
}
