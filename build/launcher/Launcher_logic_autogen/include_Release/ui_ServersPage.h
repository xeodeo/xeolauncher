...
public:
    ...
    void setupUi(QMainWindow *ServersPage)
    {
        ...
        actionRefresh = new QAction(ServersPage);
        ...
        serversView->setVerticalScrollMode(QAbstractItemView::ScrollPerPixel);
        ...
        ServersPage->addToolBar(Qt::ToolBarArea::RightToolBarArea, toolBar);
    ...
    void retranslateUi(QMainWindow *ServersPage)
    {
        ...
        actionRefresh->setText(QCoreApplication::translate("ServersPage", "Refresh", nullptr));
