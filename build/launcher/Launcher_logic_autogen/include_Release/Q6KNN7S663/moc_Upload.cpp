...
#include "../../../../../Codigo fuente/PrismLauncher-develop/launcher/net/Upload.h"
...
constexpr auto qt_meta_stringdata_CLASSNetSCOPEUploadENDCLASS = QtMocHelpers::stringData(
    "Net::Upload"
);
